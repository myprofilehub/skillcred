    ...
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 sm:py-32">
        <div className="space-y-8">
          ...
          <div className="prose prose-invert prose-indigo max-w-none space-y-12 text-gray-300">
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">1. Introduction</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">2. Information We Collect</h2>
              <div className="space-y-4 pl-4 border-l-2 border-primary/30">
                <p>
                  <strong className="text-white block mb-1">Personal Data:</strong> We may collect personally identifiable information, such as your name, email address, and professional background when you register for an account or enroll in a stream.
                </p>
                <p>
                  <strong className="text-white block mb-1">Usage Data:</strong> We automatically collect information about how you interact with our platform, including IP addresses, browser types, and pages viewed.
                </p>
                <p>
                  <strong className="text-white block mb-1">Assessment Data:</strong> Information related to your performance in skill assessments, projects, and simulations is collected to provide accreditation services.
                </p>
              </div>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">3. How We Use Your Information</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">5. Third-Party Services</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">6. Your Rights</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white border-b border-white/10 pb-2">7. Contact Us</h2>
              <p>
                If you have any questions about this Privacy Policy, please contact us at:
              </p>
              <div className="bg-secondary/50 p-6 rounded-lg border border-white/5">
                <p className="font-semibold text-white">SkillCred Support</p>
