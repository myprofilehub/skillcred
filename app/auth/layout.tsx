...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen bg-background dark:bg-background dark:bg-black text-foreground dark:text-foreground dark:text-white flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Effects */}
