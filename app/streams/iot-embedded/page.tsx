                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button size="lg" variant="outline" className="text-lg px-8 h-14 border-white/10 bg-white/5 hover:bg-white/10" asChild>
                            <a href="/brochures/SkillCred_IoT_Brochure.pdf" download>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">The modern web development stack</p>
                    </div>
            ...
            <section className="py-20 bg-secondary/10">
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">From simple static sites to complex learning platforms</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Create a responsive personal website with contact form.",
                            ...
                            },
                            {
                                ...
                                desc: "Build a CRUD-based task management system.",
                            ...
                            },
                            {
                                ...
                                tools: "React, Node.js, Payment API",
                                desc: "Develop an online store with product listings and checkout flow.",
                            ...
                            {
                                title: "Learning Management System (Capstone)",
                                tools: "React, Node.js, Cloud",
                                desc: "Build a scalable LMS with login, courses, and admin panel.",
                                ...
                                <div className="md:col-span-8 space-y-6">
                                    ...
                                    <Card className="bg-white/5 border-white/10">
                                        ...
                                        <CardContent>
                                            ...
                                            <div className="grid grid-cols-2 gap-2 text-sm">
                                                ...
                                                <div className="bg-black/20 p-2 rounded">Structure: 3</div>
                                                <div className="bg-black/20 p-2 rounded">UI/UX: 3</div>
                                                <div className="bg-black/20 p-2 rounded">Hosting: 2</div>
                                            </div>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <CardHeader>
                                                <div className="flex justify-between">
                                                    <div>
                                                        ...
                                                        <CardTitle className="text-lg">3. Database & API</CardTitle>
                                                    </div>
                                                    <Database className="w-5 h-5 text-muted-foreground" />
                                                </div>
                                            </CardHeader>
                                            <CardContent className="text-sm text-muted-foreground">
                                                Evaluation of database schema design, API structure, and data handling logic.
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="bg-white/5 border-white/10">
                                            ...
                                            <CardContent className="text-sm text-muted-foreground">
                                                Live project demonstration including performance check and security verification.
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="bg-white/5 border-white/10">
                                            ...
                                            <CardContent className="text-sm text-muted-foreground">
                                                Explain architecture, challenges faced, and problem-solving approach.
                                            </CardContent>
                                        </Card>
                                    </div>
                                </div>
                                ...
                                <div className="md:col-span-4 space-y-8">
                                    ...
                                    <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-6">
                                        ...
                                        <ul className="space-y-3 text-sm">
                                            ...
                                            <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /> Hosted 2+ Projects</li>
                                        </ul>
                                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-400 mb-8">
                                Your portfolio will show hosted project links, GitHub repositories, tech stack details, feature lists, mentor verification, and assessment scores.
                            </p>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Full Stack Developer", "Web Application Developer", "Frontend Engineer", "Backend Engineer", "Junior Software Engineer"].map(role => (
