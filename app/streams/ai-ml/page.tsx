        ...
        <main className="min-h-screen bg-background text-foreground">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm">
                            <CheckCircle2 className="w-4 h-4 text-purple-400" /> 5 real-world projects
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" className="text-lg px-8 h-14 bg-purple-600 hover:bg-purple-700 text-white shadow-lg shadow-purple-500/20" asChild>
                            <Link href="/enroll">
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">The essential stack for modern AI Engineers</p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 mb-20 max-w-5xl mx-auto">
                        {[
                            ...
                            { name: "Flask / Streamlit", sub: "Model Deployment", color: "text-white" },
                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    <div className="p-3 rounded-lg bg-purple-500/20 text-purple-400 h-fit"><GraduationCap className="w-6 h-6" /></div>
                                    <div>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Machine Learning Engineer", "AI Engineer", "NLP Engineer", "Data Scientist", "AI Support Specialist"].map(role => (
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl opacity-20 blur-2xl" />
                            <Card className="relative bg-black/80 border-white/10">
                                <CardHeader>
                                    <CardTitle className="flex justify-between items-center">
                                        <span>HR Corner (Preview)</span>
                                        <Badge className="bg-purple-600">Recruiter View</Badge>
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <Badge variant="secondary">AI Deployment</Badge>
                                        </div>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="text-center bg-gradient-to-r from-purple-900/50 to-pink-900/50 p-12 rounded-3xl border border-white/10 relative overflow-hidden">
                        <div className="relative z-10">
                            <h2 className="text-4xl font-bold mb-4">Start Your AI & ML Journey</h2>
