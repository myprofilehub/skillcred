        ...
        <main className="min-h-screen bg-background text-foreground">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm">
                            <CheckCircle2 className="w-4 h-4 text-orange-400" /> 5 real-world projects
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" className="text-lg px-8 h-14 bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-500/20" asChild>
                            <Link href="/enroll">
                        ...
                        <Button size="lg" variant="outline" className="text-lg px-8 h-14 border-white/10 bg-white/5 hover:bg-white/10" asChild>
                            <a href="/brochures/SkillCred_Fullstack_4p.pdf" download>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">The industry-standard Java stack</p>
                    </div>
            ...
            <section className="py-20 bg-secondary/10">
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">From CRUD apps to complex enterprise systems</p>
                    </div>

                    <div className="space-y-8 relative">
                        {/* Vertical Line */}
                        <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-500/50 to-purple-500/50 hidden md:block" />

                        {[
                            {
                                title: "Student Management System",
                                tools: "Java, MySQL",
                                desc: "Build a backend system to manage student records with CRUD operations.",
                            ...
                            },
                            {
                                ...
                                tools: "Spring Boot, REST APIs, MySQL",
                                desc: "Create a RESTful web application for managing books and users.",
                            ...
                            },
                            {
                                ...
                                tools: "Spring Boot, Hibernate, React",
                                desc: "Develop a full-stack payroll system with frontend and backend integration.",
                            ...
                            },
                            {
                                ...
                                tools: "Spring Boot, REST, JWT, MySQL",
                                desc: "Build a secure backend with authentication and order processing.",
                                color: "border-orange-500",
                                type: "Project 4",
                                icon: Server
                            },
                            {
                                title: "Job Portal Web Application (Capstone)",
                                tools: "Spring Boot, React, Docker",
                                desc: "Create a complete job portal with user roles, resume upload, and admin dashboard.",
                                ...
                                <div className="md:col-span-8 space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <CardHeader>
                                                <div className="flex justify-between">
                                                    <div>
                                                        ...
                                                        <CardTitle className="text-lg">3. API & Database</CardTitle>
                                                    </div>
                                                    <Database className="w-5 h-5 text-muted-foreground" />
                                                </div>
                                            </CardHeader>
                                            <CardContent className="text-sm text-muted-foreground">
                                                Evaluation of API structure, REST principles, and database schema efficiency.
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="bg-white/5 border-white/10">
                                            ...
                                            <CardContent className="text-sm text-muted-foreground">
                                                Live project demonstration including API testing and logic verification.
                                            </CardContent>
                                        </Card>
                                        ...
                                        <Card className="bg-white/5 border-white/10">
                                            ...
                                            <CardContent className="text-sm text-muted-foreground">
                                                Explain architecture, code decisions, and problem-solving approach.
                                            </CardContent>
                                        </Card>
                                    </div>
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-400 mb-8">
                                Your portfolio will show project architecture, API endpoints, database schema, GitHub links, mentor verification, and assessment scores.
                            </p>

                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    <div className="p-3 rounded-lg bg-orange-500/20 text-orange-400 h-fit"><GraduationCap className="w-6 h-6" /></div>
                                    <div>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Java Developer", "Backend Developer", "Full Stack Developer", "Software Engineer", "Application Developer"].map(role => (
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-purple-500 rounded-2xl opacity-20 blur-2xl" />
                            <Card className="relative bg-black/80 border-white/10">
                                <CardHeader>
                                    <CardTitle className="flex justify-between items-center">
                                        <span>HR Corner (Preview)</span>
                                        <Badge className="bg-orange-600">Recruiter View</Badge>
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
            ...
            <section className="py-20">
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="text-center bg-gradient-to-r from-orange-900/50 to-purple-900/50 p-12 rounded-3xl border border-white/10 relative overflow-hidden">
                        <div className="relative z-10">
                            <h2 className="text-4xl font-bold mb-4">Start Your Full Stack Development Journey</h2>
