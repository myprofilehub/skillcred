                        ...
                        <form onSubmit={handleUpload} className="space-y-4 pt-4">
                            ...
                            <div className="flex items-center gap-2 pt-2">
                                <Checkbox 
                                    ...
                                    className="border-border dark:border-border dark:border-white/20 data-[state=checked]:bg-cyan-500 data-[state=checked]:border-cyan-500"
                                />
                                <Label htmlFor="isPublic" className="font-normal text-muted-foreground dark:text-muted-foreground dark:text-slate-300">
                                ...
                                <div key={rec.id} className="p-4 flex items-center justify-between hover:bg-slate-100/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Button 
                                            ...
                                            className={`h-8 w-8 ${rec.isPublic ? 'text-green-400 hover:text-green-300 hover:bg-green-400/10' : 'text-slate-500 hover:text-muted-foreground dark:text-muted-foreground dark:text-slate-300 hover:bg-slate-500/10'}`} 
