        ...
        <div className="min-h-[calc(100vh-4rem)]">
            ...
            <div className="mb-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div>
                        <h1 className="text-3xl font-extrabold tracking-tight text-foreground dark:text-foreground dark:text-slate-900 flex items-center gap-3">
                            <div className="p-3 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl shadow-lg shadow-cyan-500/20 border border-cyan-400/20">
                                <Users className="w-6 h-6 text-foreground dark:text-foreground dark:text-slate-900" />
                            </div>
                            Mentor Applications
                        </h1>
                    ...
                    <div className="flex gap-4 w-full md:w-auto">
                        <div className="bg-slate-50 backdrop-blur-md border border-cyan-500/10 rounded-xl p-4 flex-1 md:min-w-[160px] flex items-center gap-4 hover:border-cyan-500/30 transition-colors shadow-[0_0_15px_rgba(6,182,212,0.05)]">
                            <div className="p-3 bg-cyan-500/10 text-cyan-400 rounded-xl border border-cyan-500/20">
                                <FileText className="w-5 h-5" />
                            </div>
                            <div>
                                <p className="text-xs font-semibold text-muted-foreground dark:text-muted-foreground dark:text-slate-500 uppercase tracking-wider">Total Apps</p>
                                <p className="text-2xl font-bold text-foreground dark:text-foreground dark:text-slate-900">{totalApps}</p>
                            </div>
                        </div>
                        <div className="bg-slate-50 backdrop-blur-md border border-amber-500/10 rounded-xl p-4 flex-1 md:min-w-[160px] flex items-center gap-4 hover:border-amber-500/30 transition-colors shadow-[0_0_15px_rgba(245,158,11,0.05)]">
                            <div className="p-3 bg-amber-500/10 text-amber-400 rounded-xl border border-amber-500/20">
                                <Mail className="w-5 h-5" />
                            </div>
                            <div>
                                <p className="text-xs font-semibold text-muted-foreground dark:text-muted-foreground dark:text-slate-500 uppercase tracking-wider">Pending</p>
                                <p className="text-2xl font-bold text-foreground dark:text-foreground dark:text-slate-900">{pendingApps}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        {applications.map((app: any) => (
                            <div key={app.id} className="bg-slate-50 backdrop-blur-xl rounded-2xl border border-cyan-500/10 overflow-hidden hover:border-cyan-500/30 transition-all duration-300 group flex flex-col shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_0_20px_rgba(6,182,212,0.05)] hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_0_30px_rgba(6,182,212,0.15)] relative">
                                ...
                                <div className="p-6 border-b border-cyan-500/10 bg-gradient-to-b from-slate-800/50 to-transparent relative overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-start mb-5 relative z-10">
                                        <div className="flex items-center gap-4 max-w-[75%]">
                                            ...
                                            <div className="min-w-0">
                                                <h3 className="font-bold text-foreground dark:text-foreground dark:text-slate-900 text-lg truncate drop-shadow-sm">
                                    ...
                                    <div className="flex items-center gap-5 text-xs text-muted-foreground dark:text-muted-foreground dark:text-slate-500 font-medium bg-slate-50/30 px-3 py-2 rounded-lg border border-slate-200/50">
                                ...
                                <div className="p-6 flex-1 flex flex-col space-y-6 relative">
                                    ...
                                    {app.tools && (
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground dark:text-muted-foreground dark:text-slate-300 leading-relaxed line-clamp-2 bg-slate-50/40 p-3 rounded-xl border border-cyan-500/5 backdrop-blur-sm">{app.tools}</p>
                                        </div>
                                    )}
                                    ...
                                    {(app.linkedinUrl || app.githubUrl) && (
                                        <div className="flex gap-2 pt-2">
                                            {app.linkedinUrl && (
                                                <a href={app.linkedinUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-xs font-bold text-blue-400 hover:text-foreground dark:text-foreground dark:text-slate-900 bg-blue-500/10 hover:bg-blue-600/50 px-3 py-2 rounded-lg border border-blue-500/20 transition-all shadow-[0_0_10px_rgba(59,130,246,0.1)]">
                                ...
                                {/* Card Footer (Actions) */}
                                <div className="p-4 bg-white border-t border-cyan-500/10 grid grid-cols-2 gap-3 mt-auto relative overflow-hidden backdrop-blur-md">
                                    {app.resumeUrl ? (
                                        <a 
                                            href={app.resumeUrl} 
                                            target="_blank" 
                                        ...
                                        <div className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/50 border border-slate-200 border-dashed rounded-xl text-xs sm:text-sm font-semibold text-slate-600 cursor-not-allowed">
                                    ...
                                    {app.videoUrl ? (
                                        <a 
                                            ...
                                            target="_blank" 
                                            rel="noreferrer" 
                                            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 border border-transparent rounded-xl text-xs sm:text-sm font-semibold text-foreground dark:text-foreground dark:text-slate-900 hover:from-cyan-500 hover:to-blue-500 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:shadow-[0_0_20px_rgba(6,182,212,0.5)] whitespace-nowrap"
                                        >
                                            <Play className="w-4 h-4 fill-current" /> Video Intro
                                        </a>
                                    ) : (
                                        <div className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/50 border border-slate-200 border-dashed rounded-xl text-xs sm:text-sm font-semibold text-slate-600 cursor-not-allowed whitespace-nowrap">
