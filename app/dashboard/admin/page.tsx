    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                {/* AI Entry Point */}
                <Card className="bg-slate-900/60 border-orange-500/20 backdrop-blur-sm group hover:border-orange-500/40 transition-all cursor-pointer overflow-hidden relative" asChild>
                    <Link href="/dashboard/admin/ai-workspace">
