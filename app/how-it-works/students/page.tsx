            ...
            <main className="pt-32 pb-16 px-6 max-w-7xl mx-auto">
                <div className="flex flex-col items-center text-center mb-24">
                    ...
                    <div className="flex gap-4">
                        <Button asChild size="lg" className="bg-gradient-to-r from-indigo-600 to-purple-600 text-foreground dark:text-foreground dark:text-white hover:opacity-90 shadow-lg shadow-indigo-500/25">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <div className="p-8 rounded-2xl bg-white/5 border border-border dark:border-border dark:border-white/10 hover:border-indigo-500/50 transition-colors">
