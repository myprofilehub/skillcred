...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT * FROM _prisma_migrations"], ["SELECT * FROM _prisma_migrations"])))];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
